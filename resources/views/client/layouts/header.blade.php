  <header id="main-header"
      class="fixed top-0 left-0 w-full z-50 glass-nav border-b border-white/10 transition-all duration-500 h-24">
      ...
      <div id="mobile-menu"
          ...
          <button onclick="SwAlertEstimer()"
              class="w-full bg-white text-customNoir py-3.5 rounded-xl text-xs font-bold tracking-widest uppercase">
              Publier une annonce
          </button>
      </div>
  </header>
