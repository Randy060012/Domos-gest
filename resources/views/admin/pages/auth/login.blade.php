                    ...
                    <div class="position-absolute top-0 end-0" style="width: 180px;">
                        <!-- <svg style="opacity: 0.075; width: 100%; height: auto;" width="600" height="560"
                            ...
                            <g clip-path="url(#clip0_948_1464)">
                                <mask id="mask0_948_1464" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="0"
                                    y="0" width="600" height="1200">
                                ...
                                <mask id="mask1_948_1464" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="0"
                                    y="0" width="600" height="1200">
                                    <path d="M0 0L0 1200H600L600 0H0Z" fill="white" />
                                </mask>
                    ...
                    <div class="card-body min-vh-100 d-flex flex-column justify-content-center">
                        ...
                        <div class="mt-auto">
                            ...
                            <form class="mt-4" method="POST" action="/login">
                                ...
                                <div class="d-grid">
                                    <button type="submit" class="btn btn-primary fw-bold py-2">Se connecter</button>
                                </div>
                            </form>
                        </div>
